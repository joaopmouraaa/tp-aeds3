...
public class CsvToBinaryConverter {
    ...
    public static void readById(String binaryFilePath, String carId) {
        try (RandomAccessFile raf = new RandomAccessFile(binaryFilePath, "r")) {
    ...
    //Update
    public static void update(String id, Carro carroAtualizado, String binaryFilePath) throws IOException {
    ...
    // Delete
    public static void deleteById(String binaryFilePath, String carId) {
        try (RandomAccessFile raf = new RandomAccessFile(binaryFilePath, "rw")) {
            boolean isFound = false;
            while (raf.getFilePointer() < raf.length()) {
    ...
    private static byte[] serializeCarro(Carro registroCarro) throws IOException {
        ...
        dos.writeUTF(registroCarro.getId());
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Sempre que a gente roda este arquivo, ele adiciona mais registros ao arquivo binário. Não recria o arquivo. Se rodar mais de uma vez, vai ter registros repetidos.
        // A gente precisa ver se precisamos guardar a data tanto em milissegundos quanto em string no objeto.
